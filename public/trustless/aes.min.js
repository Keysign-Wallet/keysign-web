        ...
        o = (i.AES = r.extend({
          _doReset: function () {
            if (!this._nRounds || this._keyPriorReset !== this._key) {
                ...
                n < i
                  ...
                  : ((d = t[n - 1]),
                    n % i
                      ? 6 < i &&
                        n % i == 4 &&
                        (d = (f[d >>> 24] << 24) | (f[(d >>> 16) & 255] << 16) | (f[(d >>> 8) & 255] << 8) | f[255 & d])
                      : ((d =
                          (f[(d = (d << 8) | (d >>> 24)) >>> 24] << 24) |
                          (f[(d >>> 16) & 255] << 16) |
                          (f[(d >>> 8) & 255] << 8) |
              ...
              for (var c = (this._invKeySchedule = []), s = 0; s < o; s++) {
                ...
                c[s] =
                  s < 4 || n <= 4 ? d : v[f[d >>> 24]] ^ _[f[(d >>> 16) & 255]] ^ k[f[(d >>> 8) & 255]] ^ l[f[255 & d]];
              }
            }
          },
          ...
          _doCryptBlock: function (e, r, i, o, t, n, c, s) {
            ...
            (v = ((s[f >>> 24] << 24) | (s[(u >>> 16) & 255] << 16) | (s[(h >>> 8) & 255] << 8) | s[255 & y]) ^ i[a++]),
              (_ =
                ((s[u >>> 24] << 24) | (s[(h >>> 16) & 255] << 16) | (s[(y >>> 8) & 255] << 8) | s[255 & f]) ^ i[a++]),
              (k =
                ((s[h >>> 24] << 24) | (s[(y >>> 16) & 255] << 16) | (s[(f >>> 8) & 255] << 8) | s[255 & u]) ^ i[a++]),
              (l =
                ((s[y >>> 24] << 24) | (s[(f >>> 16) & 255] << 16) | (s[(u >>> 8) & 255] << 8) | s[255 & h]) ^ i[a++]);
